  ...
  return (
    <section className="my-14 md:my-16 lg:my-10 h-[90dvh] container mx-auto px-6 md:px-8 lg:px-0">
      <div className="hero-text mb-14">
        <div className="mb-9">
          <h1 className="text-primary leading-[0px] m-0 font-bold text-5xl md:text-6xl lg:text-7xl ">
            Hi, I&#39;m Paul.
          </h1>
        </div>
      ...
      <div className="w-full h-[55dvh] lg:h-[50dvh] overflow-hidden rounded-2xl relative bg-violet-950 bg-opacity-40">
        <Gradient></Gradient>
